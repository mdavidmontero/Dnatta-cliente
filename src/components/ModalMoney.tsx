    ...
    <form onSubmit={handleSubmit(handleCreateOrder)}>
      <div className="flex flex-col justify-center p-4 text-center">
              ...
              {selectedBill > 0 && (
                <>
                  ...
                  <p className="text-lg font-bold">
                    Restante:
                    <span className="font-normal">
                      {formatCurrency(calculateVuelto(amount, selectedBill))}
                    </span>
                  </p>
                </>
              )}
        ...
        <Button
          ...
          className="w-full py-5 my-2 text-white bg-indigo-600 rounded-lg hover:bg-indigo-800 disabled:opacity-50"
        >
          Confirmar
        </Button>
      </div>
