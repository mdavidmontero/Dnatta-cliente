    ...
    <>
      ...
      <main className="min-h-screen bg-gray-100 bg-right-top bg-no-repeat lg:bg-home lg:bg-home-xl">
        <div className="py-10 mx-auto max-w-7xl">
          <div className="flex flex-col items-center space-y-2 lg:w-1/2 lg:items-start lg:text-left">
                  ...
                  {images.map((src, index) => (
                    <CarouselItem key={index} className="relative">
                      <img
                        src={src}
                        alt={`Imagen ${index + 1}`}
                        className="object-contain w-full h-[250px] sm:h-[200px] md:h-[300px] transition-transform duration-500 hover:scale-105"
                      />
                    </CarouselItem>
                  ))}
                </CarouselContent>
